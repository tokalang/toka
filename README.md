[Website (tokalang.dev)](https://tokalang.dev) | [Try Toka Online (Playground)](https://tokalang.dev/playground) | [v1.0.0-rc.2 Candidate Notes](docs/release_notes_v1.0.0-rc.2.md) | [AI Completion Card](docs/ai_completion_card_v0.1.md) | [AI Package Replication Guide](AGENTS-USER.md) | [Read the Paper](https://arxiv.org/abs/2606.01974) | [中文](README_zh.md)
...
When `v1.0.0-rc.2` is published, install that candidate explicitly rather
...
- AI completion card: [docs/ai_completion_card_v0.1.md](docs/ai_completion_card_v0.1.md)
