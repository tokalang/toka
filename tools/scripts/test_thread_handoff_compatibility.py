...
def main():
    ...
    # Executable interface bodies extend compiler/cache policy, not the v1
    # native layout or handoff protocol. Keep stale-cache rejection.
    require(version == "0.9.9-23", "compiler interface migration must be qualified")
