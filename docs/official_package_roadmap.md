...
| `official/openai_compat` | incubating v1 transport-neutral Chat Completions protocol package | modular request/response codecs, bounded stream assembly, and agent-service integration qualify | complete standalone extraction, tagged archive, public registry consumer, and offline replay gates |
