...
| `official/regex` | v1 pilot release `0.1.0`; bounded RE2-profile matcher | direct profile suite, locked/offline local-consumer import replay, tagged release archive, and static-catalog digest | optional independent compatibility corpus before a compatibility-surface expansion |
