...
|---|---|---|---|---|
| **Linux x86_64** | `x86_64` | Ubuntu 22.04 / glibc | Tier 1 Primary Release | Pending `v0.9.9-rc1` CI Run |
| **Linux aarch64** | `aarch64` | Ubuntu 24.04 / glibc | Tier 1 Primary Release | Pending `v0.9.9-rc1` CI Run |
| **macOS ARM64** | `arm64` | macOS 15 (Apple Silicon) | Tier 1 Primary Release | Pending `v0.9.9-rc1` CI Run |
| **macOS x86_64** | `x86_64` | macOS 15 Intel | Tier 1 Primary Release | Pending `v0.9.9-rc1` CI Run |
...
2. **Manual Workflow Dispatch / Tag Trigger**: Trigger `.github/workflows/release.yml` with `tag_name=v0.9.9-rc1` and `publish_release=false` via GitHub Actions workflow_dispatch.
