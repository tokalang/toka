...
> **历史审计记录，已被 2026-08 的 clean-break @Encap 规则取代。** 本文中的
...
- 测试集：`tests/pass/*.tk` 约 313 个，`tests/fail/*.tk` 约 213 个
...
- 调用点借用组：`tests/pass/g08_call_payload_alias_readonly.tk`、`tests/pass/g08_call_payload_alias_disjoint.tk`、`tests/fail/call_payload_alias_mut_mut.tk`、`tests/fail/call_payload_alias_mut_read.tk`、`tests/fail/call_payload_alias_cede_read.tk`、`tests/fail/call_readonly_ref_to_mut_param.tk`、`tests/fail/call_readonly_ref_alias_mut_params.tk`、`tests/fail/call_readonly_member_ref_alias_mut_params.tk`
...
- 权限提升拒绝：`tests/fail/readonly_ref_payload_write.tk`
